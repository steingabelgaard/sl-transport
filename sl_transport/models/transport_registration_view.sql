...
case when er.arrival_time is not null then concat(TO_CHAR(floor(er.arrival_time), 'fm00'),':',TO_CHAR((er.arrival_time-floor(er.arrival_time))*60, 'fm00'))end as arrival_time, 
case when er.departure_time is not null then concat(TO_CHAR(floor(er.departure_time), 'fm00'),':',TO_CHAR((er.departure_time-floor(er.departure_time))*60, 'fm00'))end as departure_time, 
